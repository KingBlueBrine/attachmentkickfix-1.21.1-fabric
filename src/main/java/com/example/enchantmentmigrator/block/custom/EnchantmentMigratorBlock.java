...
public class EnchantmentMigratorBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    @Override public VoxelShape getRaycastShape(BlockState state, BlockView world, BlockPos pos) {return SHAPE;}
    ...
    /*@Override
    public boolean shouldSpawnBreakParticles(BlockState state, World world, BlockPos pos) {
        return false;
    }*/
    ...
    protected void spawnBreakParticles(World world, PlayerEntity player, BlockPos pos, BlockState state) {
        ...
        BlockStateParticleEffect ObsidianParticle =
